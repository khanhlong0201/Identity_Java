...
public class UserController implements UserApi {
  ...
  @NonNull UserUseCaseServiceImpl userUseCaseServiceImpl;
  ...
  @PreAuthorize(
      "authentication.principal.claims['actorType'] == T(java_learn.identity.core.security.ActorType).ADMIN_ACTOR.ordinal()")
  @Override
